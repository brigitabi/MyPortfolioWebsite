  ...
  return (
    <div name="home" className="w-full h-screen bg-white">
      <div className="max-w-[1000px] mx-auto px-10 flex flex-col justify-center h-full">
        ...
        <h1 className="text-6xl sa:text-4xl font-bold text-[black] inline border-b-4 border-blue-800 w-1/2">
          Brigita Bizjak
        </h1>
        <h2 className="text-3xl sa:text-4xl font-thin text-[white]">
          I am a Frontend Developer in the making
        </h2>
        <p className="text-[black] py-3 max-w-[800px]">
          I'm a passionate aspiring frontend developer with a strong foundation
          in JavaScript, CSS, HTML, and React.
        </p>
        <div>
