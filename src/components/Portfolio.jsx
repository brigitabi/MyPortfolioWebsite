      ...
      <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full'>
        <div className='pb-8'>
          <p className='text-4xl font-bold border-b-4 text-gray-300 border-blue-800 flex items-center'>
            Portfolio <img src={Parrot} alt="parttot" style={{ width: '50px' }}/>
          </p>
...
<div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
  ...
  <div
    ...
    className="shadow-lg shadow-[#040c16] group container rounded-md 
              flex justify-center text-center items-center mx-auto content-div bg-center"
  >
        ...
        <a href={item.github} target="_blank">
          <button
            className="text-center rounded-lg px-4 py-3 m-2
                       bg-white text-[#0a192f] font-bold text-lg"
          >
            Code
          </button>
        </a>
